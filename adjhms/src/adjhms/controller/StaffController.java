...
public class StaffController implements Initializable {
    ...
    @FXML
    private TableColumn<Employee,String> NICNumberColumn;
    @FXML
    ...
    public static void setEmp(Employee selectedEmp) {
        StaffController.selectedEmp = selectedEmp;
    }
    
    @FXML
    private void addEmployee(ActionEvent event) throws ClassNotFoundException, SQLException, IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/adjhms/view/StaffReg.fxml"));
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        row.setOnMouseClicked((MouseEvent event) -> {
            if (event.getClickCount() == 2 && (! row.isEmpty()) ) {
                ...
                Stage st = new Stage();
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/adjhms/view/StaffDelUp.fxml"));
                //Region root = null;
                StaffController.setEmp(rowData);
                try {
                    loader.load();
        ...
        NICNumberColumn.setCellValueFactory(new PropertyValueFactory<Employee,String>("nicNumber"));
